...
<html lang="en">
  ...
  <div id="templatemo_banner_top" class="container_wapper hidden-sm hidden-xs" style="background:#fff !important;height:auto!important;">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
					<div class="visible-lg visible-md center-block logo-group-block">
						<a href="<?php echo get_home_url();?>"><img src="<?php bloginfo('template_url'); ?>/images/newlogo.jpg" alt="logo"/></a>
					</div>
                </div>
                    ...
                    <!--
                      <form action="<?php echo get_home_url(null,"package-search"); ?>" method="get">                 
                        ...
                        <div class="visible-md col-md-1">
 				    	...
 				    	<a class="getquote_anchor quote buton_custom" href="#CustomPackagesData" data-toggle="modal" data-target="#getquoteModal" data-package_quote="general">Packages</a> 
 				    	<a class="enquiry_anchor book-now1 buton_custom" href="#" data-toggle="modal" data-target="#enquiryModal" data-package_quote="general">ENQUIRY</a>  
						<a class="mob_txt mob_align" href="tel:1300650965"> <strong>1300 650 965</strong></a>
